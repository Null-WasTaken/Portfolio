...
import DaveProfile from "./Assets/Images/Dave.png"
...
export default function MobileModal() {
    ...
    return (
        ...
        <div className="flex flex-col m-auto w-full h-[500px] font-mono">
            <div className="w-[560px] h-full flex m-auto text-marsh bg-[#000] opacity-[0.9] flex-col p-4">
                ...
                <a href="#" className="text-4xl border-b-2 p-4 m-3  pb-8 flex items-center gap-2" onClick={() => {SetopenModal(true)}}>Dave <span className="text-2xl mt-2"><BiDownArrow /></span></a>
            ...
            <div className={openModal ? "fixed top-[200px]  p-7 justify-around flex flex-col m-auto w-full h-[770px] font-mono z-50 bg-[#000] text-marsh" : 'hidden'}>
             ...
             <div className="flex items-center  w-full">
                 ...
                 <img src={Dave.Img} className="w-48 ml-44" alt="Project"/>
             </div>
